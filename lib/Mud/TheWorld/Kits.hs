...
kit :: HasCallStack => Id -> V.Vector Int -> MudStack () -- TODO: Kits are incomplete. Some items such as weapons could be chosen based on PC skills.
    ...
    helper ms =
      ...
      where
        ...
        commonIds   = let fruitIds = [ iApple1, iBanana1, iOrange1 ]
                      ...
                      in [ iBread1, iSack, iSandalsLeather, iTinderbox, iTorch1, iWaterskinWithWater ] ++ is
