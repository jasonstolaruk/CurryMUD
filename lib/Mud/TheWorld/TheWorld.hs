...
createWorld = do
    ...
    putCloth iEar2 (Ent iEar2 (Just "earring") "coral earring" "" "It's a small, but tasteful, nondescript hoop." zeroBits) (Obj 1 1) Earring
    ...
    putCloth iEar4 (Ent iEar4 (Just "earring") "mithril earring" "" "It's a small, but tasteful, nondescript hoop." zeroBits) (Obj 1 1) Earring
    putCloth iNoseRing1 (Ent iNoseRing1 (Just "nose") "nose ring" "" "It's a plain silver stud, intended to be worn on the nose." zeroBits) (Obj 1 1) NoseRing
    putCloth iNoseRing2 (Ent iNoseRing2 (Just "nose") "nose ring" "" "It's a plain silver stud, intended to be worn on the nose." zeroBits) (Obj 1 1) NoseRing
    putCloth iNoseRing3 (Ent iNoseRing3 (Just "nose") "nose ring" "" "It's a plain silver stud, intended to be worn on the nose." zeroBits) (Obj 1 1) NoseRing
    ...
    putCloth iBracelet1 (Ent iBracelet1 (Just "bracelet") "bronze bracelet" "" "It's a simple bronze bracelet." zeroBits) (Obj 1 1) Bracelet
    putCloth iBracelet2 (Ent iBracelet2 (Just "bracelet") "silver bracelet" "" "It's a simple silver bracelet." zeroBits) (Obj 1 1) Bracelet
    putCloth iBracelet3 (Ent iBracelet3 (Just "bracelet") "gold bracelet" "" "It's a simple gold bracelet." zeroBits) (Obj 1 1) Bracelet
    putCloth iBracelet4 (Ent iBracelet4 (Just "bracelet") "platinum bracelet" "" "It's a simple platinum bracelet." zeroBits) (Obj 1 1) Bracelet
    putCloth iRing1 (Ent iRing1 (Just "ring") "bronze ring" "" "It's a simple bronze ring." zeroBits) (Obj 1 1) Ring
    putCloth iRing2 (Ent iRing2 (Just "ring") "silver ring" "" "It's a simple silver ring." zeroBits) (Obj 1 1) Ring
    putCloth iRing3 (Ent iRing3 (Just "ring") "gold ring" "" "It's a simple gold ring." zeroBits) (Obj 1 1) Ring
    putCloth iRing4 (Ent iRing4 (Just "ring") "platinum ring" "" "It's a simple platinum ring." zeroBits) (Obj 1 1) Ring
