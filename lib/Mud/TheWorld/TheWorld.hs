...
createWorld = do
    ...
    putRm iClothCloset [ iChemise, iTunic, iApron, iTabard, iGreyCoat, iFrockCoat ] mempty (Rm "Clothing closet" "This closet holds clothing." zeroBits [ StdLink West iCentral, StdLink Down iAccessoriesCloset ])
    ...
    putCloth iGreyCoat (Ent iGreyCoat (Just "coat") "mouse-grey coat" "" "Sure to keep its wearer warm in all but the coldest of weather, this long-sleeved coat extends slightly past the knees, and features a tall collar followed by ten large silver buttons along its length." zeroBits) (Obj 1 1) Coat
    putCloth iFrockCoat (Ent iFrockCoat (Just "coat") "woman's red frock coat" "" "This fashionable long-sleeved coat is made of soft, bright-red fabric inlaid with a rich floral brochade. Six black buttons in a vertical line across the chest make this a particularly figure-flattering garment when closed." zeroBits) (Obj 1 1) Coat
