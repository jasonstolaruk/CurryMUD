...
createWorld = do
    ...
    putCloth iGreyCoat (Ent iGreyCoat (Just "coat") "mouse-grey coat" "" "Sure to keep its wearer warm in all but the coldest of weather, this heavy, long-sleeved coat extends slightly past the knees, and features a tall collar followed by ten large silver buttons along its length." zeroBits) (Obj 1 1) Coat
    putCloth iFrockCoat (Ent iFrockCoat (Just "coat") "woman's red frock coat" "" "This fashionable long-sleeved coat is made of soft, bright-red fabric inlaid with a rich floral brochade. Six black buttons down the chest make this a particularly figure-flattering garment when fastened." zeroBits) (Obj 1 1) Coat
    putCloth iBreeches1 (Ent iBreeches1 (Just "breeches") "pair of knee-length yellow breeches" "pairs of knee-length yellow breeches" "These thin, tight-fitting breeches extend just past the knees, where they are secured with drawstrings." zeroBits) (Obj 1 1) Trousers
    putCloth iBreeches2 (Ent iBreeches2 (Just "breeches") "pair of knee-length yellow breeches" "pairs of knee-length yellow breeches" "These thin, tight-fitting breeches extend just past the knees, where they are secured with drawstrings." zeroBits) (Obj 1 1) Trousers
