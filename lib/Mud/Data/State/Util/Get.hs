...
getLightIsLit :: HasCallStack => Id -> MudState -> Bool
getLightIsLit i = view lightIsLit . getLight i

-----

getLightSecs :: HasCallStack => Id -> MudState -> Seconds
getLightSecs i = view lightSecs . getLight i
