...
putArm i e o a = tweaks [ activeEffectTbl.ind i .~ []
                        , armTbl         .ind i .~ a
                        , entTbl         .ind i .~ e
                        , objTbl         .ind i .~ o
...
putCloth i e o c = tweaks [ activeEffectTbl.ind i .~ []
                          , clothTbl       .ind i .~ c
                          , entTbl         .ind i .~ e
                          , objTbl         .ind i .~ o
                          , pausedEffectTbl.ind i .~ []
...
putCon i e o is coi mc con = tweaks [ activeEffectTbl.ind i .~ []
                                    , clothTbl       .at  i .~ mc
                                    , coinsTbl       .ind i .~ coi
                                    , conTbl         .ind i .~ con
                                    , entTbl         .ind i .~ e
...
putHolySymbol i e o h = tweaks [ activeEffectTbl.ind i .~ []
                               , entTbl         .ind i .~ e
...
putNpc i e is c em m = tweaks [ activeEffectTbl.ind i .~ []
                              , coinsTbl       .ind i .~ c
                              , entTbl         .ind i .~ e
                              , eqTbl          .ind i .~ em
                              , invTbl         .ind i .~ is
...
putObj i e o = tweaks [ activeEffectTbl.ind i .~ []
                      , entTbl         .ind i .~ e
                      , objTbl         .ind i .~ o
                      , pausedEffectTbl.ind i .~ []
...
putPla i e is c em m r t pc pla = tweaks [ activeEffectTbl .ind i .~ []
                                         , coinsTbl        .ind i .~ c
                                         , entTbl          .ind i .~ e
                                         , eqTbl           .ind i .~ em
                                         , invTbl          .ind i .~ is
...
putRm i is c r = tweaks [ activeEffectTbl.ind i .~ []
                        , coinsTbl       .ind i .~ c
                        , invTbl         .ind i .~ is
                        , pausedEffectTbl.ind i .~ []
                        , rmTbl          .ind i .~ r
...
putVessel i e o c = tweaks [ activeEffectTbl.ind i .~ []
                           , entTbl         .ind i .~ e
                           , objTbl         .ind i .~ o
                           , pausedEffectTbl.ind i .~ []
...
putWpn i e o w = tweaks [ activeEffectTbl.ind i .~ []
                        , entTbl         .ind i .~ e
                        , objTbl         .ind i .~ o
                        , pausedEffectTbl.ind i .~ []
...
putWritable i e o w = tweaks [ activeEffectTbl.ind i .~ []
                             , entTbl         .ind i .~ e
                             , objTbl         .ind i .~ o
                             , pausedEffectTbl.ind i .~ []
