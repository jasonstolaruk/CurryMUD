...
* About 85 player commands, 50 administrator commands, and 55 commands for debugging purposes.
...
0. Inside `$HOME/CurryMUD`, run `stack setup` to get GHC 8 on your machine. (The `stack.yaml` file points to [LTS Haskell 7.11](https://www.stackage.org/lts-7.11), which uses GHC 8.0.1.)
