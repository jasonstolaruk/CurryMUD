...
* About 85 player commands, 50 administrator commands, and 65 commands for debugging purposes.:nut_and_bolt:
...
0. Inside `$HOME/CurryMUD`, run `stack setup` to get GHC 8 on your machine. (The `stack.yaml` file points to [a recent nightly resolver](https://www.stackage.org/snapshots), which uses GHC 8.0.1.)
