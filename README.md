...
0. Inside `$HOME/CurryMUD`, run `stack setup` to get GHC 8 on your machine. (The `stack.yaml` file points to [LTS Haskell 7.9](https://www.stackage.org/lts-7.9), which uses GHC 8.0.1.)
